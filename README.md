...
```
1) All rune tx start their ScriptPubKey with 1 pushbyte encoding the letter **R** in hex:  
```
0x 01 52  
= OP_PUSHBYTES_1 52  
= R  
```
2) This is followed by a **transfer** data push:  
```
...
```
3) In a mint tx this is then followed by an additional **issuance** data push:  
```
